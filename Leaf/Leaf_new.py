...
ROOT_DIR = '/home/ec2-user/Mask/Mask_RCNN/'
...
dataset_dir ='/home/ec2-user/synthetic_arabidopsis_LSC'
...
class LeavesConfig(Config):
    ...
    GPU_COUNT = 1 
    IMAGES_PER_GPU = 2  # Modify according to your GPU memory. We trained this on AWS P2
...
def train(model, dataset_dir):
    ...
    model.train(dataset_train, dataset_val,
                learning_rate=config.LEARNING_RATE,
                epochs = 160, # Discuss with Dr Noah 
                augmentation=augmentation,
                layers='all')
